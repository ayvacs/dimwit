/*
    ...
    deploy-commands-guild.js (npm run deploy-commands-guild)

    Register and update commands to the development guild. It is necessary to
    perform these functions in a separate file that is called only when changes
    to their definition (description, options, etc.) are made since:
    * commands need to be registered only once
    * it is only necessary to update them when changes to their definition
      (description, options, etc.) are made
